# -*- coding: utf-8 -*-
"""data_loader_modified.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JVzcC2bcgIkluafjag5_R7pYRUWVcENh
"""

# -*- coding: utf-8 -*-
"""bert_encoder_modified.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1U_2J9Idv57geXTBXT2lC9LpsB5mHQYzn
"""
...
class BERTEncoder(nn.Module):
    ...
    def forward(self, token, att_mask):
        ...
        """
        result = self.bert(token, attention_mask=att_mask)
        x = result[1]
        return x
...
class BERTHiddenStateEncoder(BERTEncoder):
    ...
    def tokenize(self, item):
        ...
        for idx, token in enumerate(tokens):
          ...
          re_tokens += tokenized
          # If BERT cannot recognize the token, assign the token as "."
          if self.tokenizer.tokenize(token) == []:
            re_tokens += "."
            num_new_tokens = 1
          else:
            num_new_tokens = len(re_tokens) - len(new_index)
          # print(re_tokens)
          new_index.extend([idx] * num_new_tokens)
          # print(new_index)
          cur_pos += 1
        re_tokens.append('[SEP]')
